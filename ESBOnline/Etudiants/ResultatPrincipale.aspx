<%@ Page Title="" Language="C#" MasterPageFile="~/Etudiants/Eol.Master" AutoEventWireup="true"
    CodeBehind="ResultatPrincipale.aspx.cs" Inherits="ESPOnline.Etudiants.ResultatPrincipale" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-xs-10">
        <center>
            ...
            <br />
            <h2 class="style1">Seulement  les modules qui ont été évalués seront affichés</h2>
        </center>
...
<asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT moy_general,lib_decision_session_p,nb_ects_sp FROM ESP_INSCRIPTION WHERE (ID_ET =:ID_ET) and annee_deb =(select max (annee_deb)  from societe)">
                                       <SelectParameters>
        ...
        <center>
            <asp:Panel ID="Panel3" runat="server">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnectionString %>"
                    ProviderName="<%$ ConnectionStrings:DefaultConnectionString.ProviderName %>"
                    SelectCommand="SELECT MOY_GENERAL as moyenne_general, LIB_DECISION_SESSION_P as DECISION  FROM ESP_INSCRIPTION WHERE code_cl not in ('1 MAD') and ANNEE_DEB =(select max (annee_deb)  from societe) and (ID_ET =:ID_ET) ">
                    <SelectParameters>
                        <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
