<%@ Page Title="" Language="C#" MasterPageFile="~/Etudiants/Eol.Master" AutoEventWireup="true"
    CodeBehind="evaluation2.aspx.cs" Inherits="ESBOnline.Etudiants.evaluation2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <%--<div class="row">
        ...
        <div class="col-lg-6">
                ...
                <div class="row">
                    <asp:TextBox ID="TBnmbr" runat="server" ReadOnly="True"></asp:TextBox></div>
                <div class="row">
                    <asp:DropDownList ID="DDlistmodule" CssClass="form-control" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DDlistmodule_SelectedIndexChanged"
                ...
                <div class="row">
                <asp:Label ID="Label2" CssClass="h3 text-info" runat="server" Text="Classe :"></asp:Label>
                    <asp:Label ID="LabelClasse" CssClass="h3 text-info" runat="server" Style="font-size: large" Text="Label"></asp:Label></div>
                <div class="row">
                <asp:Label ID="Label1" CssClass="h3 text-info" runat="server" Text="Module :"></asp:Label>
                    <asp:Label ID="LabelModule" CssClass="h3 text-info" runat="server" Text="Label"></asp:Label></div>
                
            <asp:Panel ID="Panel2" runat="server" BackColor="#A71F14">
            <div class="row">
                <div class="col-lg-3">
                </div>
                <div class="col-lg-6">
                                   ...
                                   Width="798px">
                                                <table class="style27">
                                                 ...
                                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                                ...
                                                                ProviderName="<%$ ConnectionStrings:DefaultConnectionString.ProviderName %>" SelectCommand="SELECT     NUM_SEMESTRE
FROM         ESP_MODULE_PANIER_CLASSE_SAISO
GROUP BY CODE_MODULE, CODE_CL, NUM_SEMESTRE, ANNEE_DEB
HAVING      (CODE_MODULE = :code) AND (CODE_CL = :classe) AND (ANNEE_DEB = '2017')">
                                                                <SelectParameters>
                                                        ...
                                                        <td>
                                                          <table class="style27">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <strong>
                                                                        <asp:Panel ID="q1panel2" runat="server" BackColor="White" CssClass="style12" 
                                                                ...
                                                                <table class="style1">
                                                                    <tr>
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td class="style4">
                                                                            <strong>1. La pédagogie est adaptée (Communication claire, rythme adapté,<br /> 
                                                                            &nbsp;encadrement, réponses claires et précises aux questions, supports suffisants
                                                                            <br />
                                                                            et appropriés, …)&nbsp;</strong></td>
                                                                        <td>
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                ...
                                                                <table class="style1">
                                                                    <tr>
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td class="style46">
                                                                            <strong>2. Le contenu est riche et intéressant, les objectifs d&#39;apprentissage, 
                                                                            les prérequis<br /> &nbsp;nécessaires au suivi de l&#39;enseignement et les modalités de 
                                                                            contrôle ont été
                                                                            <br />
                                                                            clairement indiqués,…&nbsp;</strong></td>
                                                                        <td>
                                                                ...
                                                                <table class="style1">
                                                                    <tr>
                                                                        <td>
                                                                            &nbsp;</td>
                                                                        <td class="style43">
                                                                            <span class="style2"><strong style="font-size: medium">3. Cet enseignement m’a 
                                                                            permis de progresser et d&#39;acquérir de nouvelles
                                                                            <br />
...
ZH-CN;mso-bidi-language:AR-SA"><strong>4. L’ambiance générale de la classe est bonne (Groupe homogène, motivation,<br /> &nbsp;émulation, interaction 
                                                                            enrichissante, respect mutuel,…)</strong><span style="mso-spacerun:yes"><strong>&nbsp;
                                                                            </strong></span></span>
                                                                        </td>
                                                                        <td class="style44">
                                                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>
...
ZH-CN;mso-bidi-language:AR-SA">5. Le nombre d&#39;heures de travail hebdomadaire moyen que j&#39;ai fourni pour cet enseignement (en plus des heures du programme 
                                                                            d&#39;études) est de...</span><span class="style16" style="font-size:10.0pt;mso-fareast-font-family:&quot;Times New Roman&quot;;mso-ansi-language:FR;mso-fareast-language:
