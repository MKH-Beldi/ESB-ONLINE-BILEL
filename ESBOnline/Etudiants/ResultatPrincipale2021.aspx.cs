...
{
    public partial class ResultatPrincipale2021 : System.Web.UI.Page
    {
        public string ID_ET;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
         //  Response.Redirect("~/Online/default.aspx");
            ...
            string ID_ET = Session["ID_ET"].ToString();
                // Label16.Text= DAL.ResctsDAO.Instance.returnCL(ID_ET);
            ...
            if (Session["ID_ET"] == null || Session["CIN_PASS"] == null)
                ...
                Label5.Text = Session["NOM_ET"].ToString();
                Label6.Text = Session["PNOM_ET"].ToString();
                Label12.Text = Session["ID_ET"].ToString();
              ...
              //  Response.Write("<script LANGUAGE='JavaScript'> alert('Problème Administratif, Veuillez contacter le service compétant')</script>");
                ...
                //    Response.Write("<script LANGUAGE='JavaScript'> alert('VEUILLEZ REESSAYER ULTERIEUREMENT')</script>");
                //    //DetailsView2.Visible = false;

                //}
                //GridView1.Visible = false;
                //ici returne deconnecter GridView2.Visible = true;
