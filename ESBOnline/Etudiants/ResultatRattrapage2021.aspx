<%@ Page Title="" Language="C#" MasterPageFile="~/Etudiants/Eol.Master" AutoEventWireup="true" CodeBehind="ResultatRattrapage2021.aspx.cs" Inherits="ESPOnline.Etudiants.ResultatRattrapage2021" %>
        ...
        <center>
            ...
            <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
                                           ...
                                           <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnectionString %>"
                                            ProviderName="<%$ ConnectionStrings:DefaultConnectionString.ProviderName %>" 
                                               SelectCommand="SELECT MOY_RATT,LIB_DECISION_SESSION_Rat,NB_ECTS_SR FROM ESP_INSCRIPTION,societe 
                                                WHERE (ID_ET =:ID_ET) and AFFICH_NOTE='O'  
                                               and ESP_INSCRIPTION.annee_deb =(select max(annee_deb) from societe)  ">
                                       <SelectParameters>
            <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
        </SelectParameters>
                                        </asp:SqlDataSource>
            ...
            CellPadding="3" CellSpacing="1" GridLines="None">
                ...
                <Fields>
                    ...
                    <asp:BoundField DataField="MOY_RATT" HeaderText="Moyenne rattrapage:" 
...
&nbsp;<center>
            <asp:Panel ID="Panel2" runat="server">
                <asp:GridView ID="GridView2" Visible="false" runat="server" OnDataBound="OnDataBound" OnRowDataBound="GridView1_test" 
                    OnRowCreated="grdView2_RowCreated"  Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="NB_ECTS" SortExpression="NB_ECTS"  Visible="false">
                            <ItemTemplate>
 ...
 <FooterTemplate>
  ...
  <asp:Label ID="Label11" runat="server" Text='<%# Bind("NB_ECTS") %>'></asp:Label>
             ...
             <%--         <tr><td>       <asp:Label ID="Label17" runat="server" /></td></tr>--%>
                    ...
                    <asp:BoundField DataField="MOY_MODULE" HeaderText="MOYENNE MODULE PRINCIPALE"  ItemStyle-Width="50"
                            SortExpression="MOY_MODULE">
                             
                        </asp:BoundField>
                        <asp:BoundField DataField="MOY_MODULERATT" HeaderText="MOYENNE MODULE RATTRAPAGE"  ItemStyle-Width="50" 
