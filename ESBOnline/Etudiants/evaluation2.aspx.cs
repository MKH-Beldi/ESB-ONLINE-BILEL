...
namespace ESBOnline.Etudiants
{
    public partial class evaluation2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                else
                {
                    ...
                    LabelClasse.Text = Session["code_classe"].ToString();//services.Instance.getCl(Session["ID_ET"].ToString());
