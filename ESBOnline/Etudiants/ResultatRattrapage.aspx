<%@ Page Title="" Language="C#" MasterPageFile="~/Etudiants/Eol.Master" AutoEventWireup="true" CodeBehind="ResultatRattrapage.aspx.cs" Inherits="ESPOnline.Etudiants.ResultatRattrapage" %>
 ...
 <div class="col-xs-1">
    ...
    <div class="col-xs-10">
        ...
        <center>
            ...
            CellPadding="3" CellSpacing="1" GridLines="None">
                ...
                <RowStyle BackColor="#000066" ForeColor="White" Font-Bold="True" />
                      ...
                      <%-- <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT MOY_GENERAL, LIB_DECISION_SESSION_P FROM ESP_INSCRIPTION WHERE (ID_ET =:ID_ET) and annee_deb ='2016'">
                                       <SelectParameters>
            <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
        </SelectParameters>
                                        </asp:SqlDataSource>--%>
                                         <%--  <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT MOY_RATT,LIB_DECISION_SESSION_Rat,NB_ECTS_SR FROM ESP_INSCRIPTION WHERE (ID_ET =:ID_ET) and annee_deb =(select max (annee_deb)  from societe)">
                                       <SelectParameters>
            <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
        </SelectParameters>
                                        </asp:SqlDataSource>--%>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                                            ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" SelectCommand="SELECT MOY_RATT,LIB_DECISION_SESSION_Rat,NB_ECTS_SR FROM ESP_INSCRIPTION where code_cl in ('3-LFIG-1','3-LFIG-2','3-LFG-1' ,  '3-LFG-2'  ,  '3-LFG-3'
,'2-LFG-1' ,  '2-LFG-2'  ,  '2-LFG-3' ,  '2-LFG-4' , '2-LFG-5' , 
'1-MDSI-1' ,  '1-MDSI-2',
'1-MKD-1' ,  '1-MKD-2',
'1-CCA-1',
'1-BA-1' ,  '1-BA-2',
                '1-LSG-1','1-LSG-2','1-LSG-3','1-LSG-4','1-LSG-5','1-LSG-6','1-LSG-7','2-LFIG-1','2-LFIG-2','1-BC-1','1-BC-2','1-BC-3','1-BC-4') and (ID_ET =:ID_ET) and annee_deb =(select max (annee_deb)  from societe)">
                                       <SelectParameters>
            <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
        </SelectParameters>
                                        </asp:SqlDataSource>
...
&nbsp;<center>
            <asp:Panel ID="Panel2" runat="server">
                <asp:GridView ID="GridView2" runat="server" OnDataBound="OnDataBound" OnRowCreated="grdView2_RowCreated"  Width="90%"
                            ...
                            <ItemTemplate>
                             ...
                             <FooterTemplate>
                                <div style="text-align: center;">
                                    <table  width="100%" >
                    <tr><td ><asp:Label ID="Label15" runat="server" Text="Total ECTS encaissés:" /></td>
                    ...
                    <td >       <asp:Label ID="Label2" runat="server" /></td></tr>
                   </table>
                                </div>
                            </FooterTemplate>
                            </asp:TemplateField>
