<%@ Page Title="" Language="C#" MasterPageFile="~/Etudiants/Eol.Master" AutoEventWireup="true" CodeBehind="CCNA4.aspx.cs" Inherits="ESPOnline.Etudiants.CCNA4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  ...
  <h3 class="text-center text-info"><strong>Bienvenue à la page d'inscription à la certification CCNA4 </strong></h3>
                       ...
                       <div class="form-group">
                        ...
                        DisplayDateFormat="dd/MMM/yy" DataValueField="DATE_CERT" 
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                                        ...
                                        SelectCommand="SELECT ( to_char(date_cert,'dd/MM/yyyy')) as date_cert FROM &quot;COMPT_CERT&quot; where type_cert=4 order by date_cert">
                                    </asp:SqlDataSource>
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group pull-right">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                                        ...
                                        SelectCommand="SELECT UNIQUE (NOM_JETON) FROM JETON WHERE type_ccna=4 and  (NOM_JETON NOT IN (SELECT NOM_JETON FROM scoesb02.ESP_INSCRI))and rownum &lt;= 1">
                                    </asp:SqlDataSource>
                              </div>
                                   </div>
                                       </div> 
                           ...
                           <div class="form-inline">
                            <div class="form-group">
                                <asp:Label ID="Label6" CssClass="text-info h4" runat="server" Text="Nombre d'Inscription :"></asp:Label>
                                  ...
                                  <asp:Label ID="Label25" runat="server" BackColor="Aqua"></asp:Label>
                                  </div>
                                     <div class="form-group pull-right">
                               <br /> 
...
<center>
                         ...
                         onselectedindexchanged="GridView1_SelectedIndexChanged">
                                 ...
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                     ConnectionString="<%$ ConnectionStrings:DefaultConnectionString %>" 
                                     ProviderName="<%$ ConnectionStrings:DefaultConnectionString.ProviderName %>" 
                                     SelectCommand="SELECT * FROM &quot;ESP_INSCRI&quot; WHERE (&quot;ID_ET&quot; = :ID_ET) AND TYPE_CCNA=4">
                                     <SelectParameters>
