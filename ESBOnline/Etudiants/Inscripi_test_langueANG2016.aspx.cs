...
{
    public partial class Inscripi_test_langueANG2016 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dt = service.get_id_etud_formatioParDateANG(id_et, "20/04/16");
                // pl1.Visible = false;
                ...
                else
                {
                    ...
                    if (codecl.StartsWith("5"))
                    {
                        ...
                        count_nbfr = service.countnbinscrANG_date();
                        lblnb.Text = count_nbfr;

                        int nbfr = Convert.ToInt32(lblnb.Text);
                        ...
                        {
                            Response.Write(@"<script language='javascript'>alert('nous sommes désolés,le nombre est atteint 50 étudiants');</script>");
                            pllo.Visible = false;
                            panel1.Visible = true;
                        }
