<%@ Page Title="" Language="C#" MasterPageFile="~/Administration/Administration.Master" AutoEventWireup="true" CodeBehind="Suivi_Absence_Par_Classe.aspx.cs" Inherits="ESPOnline.Administration.Suivi_Absence_Par_Classe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../bootstrap/bootstrap-select.js" type="text/javascript"></script>
...
t1.code_module=t2.code_module and t1.id_et=t3.id_et  and code_cl=:code_cl and t1.ANNEE_DEB=t4.ANNEE_DEB order by t1.date_seance desc">
                        <SelectParameters>
            ...
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="Label2" runat="server" Text="Suivi absence" CssClass="active" Font-Bold="True"
