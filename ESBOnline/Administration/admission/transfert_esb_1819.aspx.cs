...
{
    public partial class transfert_esb_1819 : System.Web.UI.Page
    {
        ...
        protected void RadButton1_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridDataItem item in RadGrid1.MasterTableView.Items)
            {
                ...
                if (chk.Checked == true)
                {
                    ...
                    //DAL.Admission.Instance.update_code_decision(ID);
                    DAL.Admission.Instance.transfer_to_etudiant(ID);

                    //DAL.Admission.Instance.updatedecisionBONUS(ID);
          ...
          string  messag = "alert('Transfert effectué aves succès')";
            ScriptManager.RegisterClientScriptBlock((sender as Control), this.GetType(), "alert", messag, true);
