...
CodeBehind="CJ_liste.aspx.cs" Inherits="ESPOnline.Administration.admission.CJ_liste"  MasterPageFile="~/Administration/admission/ad.Master" %>
  ...
  <center>    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/Excel_XLSX.png"
    ...
    <telerik:RadGrid ID="RadGrid1" runat="server" ShowFooter="true"  AllowFilteringByColumn="True" AllowSorting="True" 
     CssClass="RadGridCustomClass" OnExcelMLWorkBookCreated="RadGrid1_ExcelMLWorkBookCreated"
            ...
            DataSourceID="ee"     BorderStyle="Groove" OnPreRender="RadGrid1_PreRender" Height="694px"
             >
...
t1.SPECIALITE_ESP_ET='08' then 'Master professionnel de management digital et systèmes d information'  
                         when t1.SPECIALITE_ESP_ET='09' then 'Master professionnel en Marketing digital' when t1.SPECIALITE_ESP_ET='10' then 'Master professionnel en innovation et entrepreneuriat' 
                      when t1.SPECIALITE_ESP_ET='16' then 'Licence Informatique Mention Business Computing Parcours Information System'
                          ...
                          when t1.SPECIALITE_ESP_ET='20' then 'Licence Business Computing'
                          when t1.SPECIALITE_ESP_ET='23' then 'Licence en Sciences de Gestion'
                          when t1.SPECIALITE_ESP_ET='24' then 'Master Professionnel en Business Analytics -Exécutive'
                          when t1.SPECIALITE_ESP_ET='25' then 'Master Professionnel en Management Digital et Système dInformation - Exécutive'
                          when t1.SPECIALITE_ESP_ET='26' then 'Master Professionnel en Marketing Digital -Exécutive'
                          when t1.SPECIALITE_ESP_ET='27' then 'Master Professionnel Management Digital et Système dInformation (Alternance-Vermeg)'
...
SPECIALITE_ESP_ET='08' then 'Master professionnel de management digital et systèmes d information'   when SPECIALITE_ESP_ET='09' then 'Master professionnel en Marketing digital' when SPECIALITE_ESP_ET='10' then 'Master professionnel en innovation et entrepreneuriat' 
        ...
        when SPECIALITE_ESP_ET='01' then 'INFO' when SPECIALITE_ESP_ET='02' then 'TELECOM'   when SPECIALITE_ESP_ET='06' then 'Licence en sciences de gestion Parcours Management'  when SPECIALITE_ESP_ET='07'  then 'Licence en sciences de gestion Parcours comptabilité'   when 
SPECIALITE_ESP_ET='08' then 'Master professionnel de management digital et systèmes d information'  
                         when SPECIALITE_ESP_ET='09' then 'Master professionnel en Marketing digital' when SPECIALITE_ESP_ET='10' then 'Master professionnel en innovation et entrepreneuriat' 
                      when SPECIALITE_ESP_ET='16' then 'Licence Informatique Mention Business Computing Parcours Information System'
                          ...
                          when SPECIALITE_ESP_ET='20' then 'Licence Business Computing'
                          when SPECIALITE_ESP_ET='23' then 'Licence en Sciences de Gestion'
                          when SPECIALITE_ESP_ET='24' then 'Master Professionnel en Business Analytics -Exécutive'
                          when SPECIALITE_ESP_ET='25' then 'Master Professionnel en Management Digital et Système dInformation - Exécutive'
                          when SPECIALITE_ESP_ET='26' then 'Master Professionnel en Marketing Digital -Exécutive'
                          when SPECIALITE_ESP_ET='27' then 'Master Professionnel Management Digital et Système dInformation (Alternance-Vermeg)'
