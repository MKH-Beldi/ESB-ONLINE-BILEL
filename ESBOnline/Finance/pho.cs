...
namespace Image_blob2
{
    public class pho
    {
          #region sing
        OracleConnection mySqlConnection = new OracleConnection("DATA SOURCE=10.100.100.10:1521/bdesb10g ;PERSIST SECURITY INFO=True;USER ID=sco_admis1415;PASSWORD=sco_admis1415");
