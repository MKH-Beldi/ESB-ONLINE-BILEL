    ...
    public partial class Images_reçu : System.Web.UI.Page
    {
           protected void Page_Load(object sender, EventArgs e)
                ...
                void CreateImage(string id)
            {
                ...
                {
                    using (OracleConnection mySqlConnection = new OracleConnection("DATA SOURCE=10.0.0.5:1521/dbesb23 ;PERSIST SECURITY INFO=True;USER ID=SCO_admis1415;PASSWORD=SCO_admis1415"))
                    {
