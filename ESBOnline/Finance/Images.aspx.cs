...
{
    using (OracleConnection mySqlConnection = new OracleConnection("DATA SOURCE=10.0.0.5:1521/dbesb23 ;PERSIST SECURITY INFO=True;USER ID=admis1718;PASSWORD=ADMIS_ESB"))
            {
