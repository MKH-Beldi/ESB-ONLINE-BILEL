<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PHOTO.aspx.cs" Inherits="Image_blob2.PHOTO" %>
 ...
 <asp:DropDownList ID="DropDownList1" runat="server"  AutoPostBack="True" Width="400px" Height="30px"   DataTextField="tt" DataValueField="ID_ET" OnSelectedIndexChanged="tt" >
  ...
  <br />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server"  
        ...
        SelectCommand="select e1.id_et as id_et, e2.NOM_ET||''||e2.PNOM_ET||''||e1.id_et ||''||e2.numcompte as tt,e2.NOM_ET from esp_recu e1,ESP_ETUDIANt e2 where e1.id_et like '17%' and e1.etat='N' and trim(e1.id_et)=trim(e2.id_et) and SPECIALITE_ESP_ET in ('05','03','01','02','04') order by (e1.date_saisie) desc"></asp:SqlDataSource>
