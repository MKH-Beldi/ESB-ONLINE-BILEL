<%@ Page Title="" Language="C#" MasterPageFile="~/Finance/RECU.Master" AutoEventWireup="true" CodeBehind="listevalider.aspx.cs" Inherits="/.Finance.listevalider" %>
            ...
            <div class="col-xs-10">
                ...
                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" 
                     ...
                     <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                        ...
                        SelectCommand="select e2.id_et,e3.nom_et,e3.pnom_et from  SCO_ADMIS1415.esp_recu e2, SCO_ADMIS1415.esp_etudiant e3 where trim(e2.id_et) like '18%' AND e2.etat='V'
and e2.id_et not in(select id_et from scoesp09.esp_inscription e1 where trim(id_et) like '18%') and e2.id_et=e3.id_et ">
