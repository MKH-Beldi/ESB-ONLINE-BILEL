...
{
    public partial class ResultatRattrapage2021P : System.Web.UI.Page
    {
        public string ID_ET;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LIB_DECISION_SESSION_RAT = "";
            //DAL.OrientationDAO.getDecisionRat(ID_ET, "2021");
            CODE_DECISION_SESSION_RAT = "";
            //DAL.OrientationDAO.getCodeDecisionRat(ID_ET, "2021");
            //Moy_R = DAL.OrientationDAO.getMoyRat(ID_ET, "2021");
            ...
            {
                //Problème Administratif, Veuillez contacter le service compétant
                Response.Write("<script LANGUAGE='JavaScript'> alert('Aucune saisie n a été effectuée')</script>");
                GridView2.Visible = false;
                Label18.Visible = false;
