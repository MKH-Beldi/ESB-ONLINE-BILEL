    ...
    public partial class Recupérer_mot_de_passe : System.Web.UI.Page
    {
        ...
        protected void btn_renitialiser_mot_depasse_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (service_motdepasse.GET_ADRESSE_MAIL_parent(_id_et) == Adresse_mail_esp.Text)
                {

                    string idi = service_motdepasse.GET_ADRESSE_MAIL_parent(_id_et).ToString();
                    ...
                    this.SendHtmlFormattedEmail((service_motdepasse.GET_ADRESSE_MAIL_parent(_id_et).ToString().Trim()), " Récupérer votre  mot de passe d'intranet Esprit  perdu ou oublié", body);
                    string message;
