<%@ Page Title="" Language="C#" MasterPageFile="~/Parents/Par.Master" AutoEventWireup="true" CodeBehind="ResultatRattrapage2021P.aspx.cs" Inherits="ESPOnline.Parents.ResultatRattrapage2021P" %>
            ...
            <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
                                           ...
                                           <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnectionString %>"
                                            ProviderName="<%$ ConnectionStrings:DefaultConnectionString.ProviderName %>" 
                                               SelectCommand="SELECT MOY_RATT,LIB_DECISION_SESSION_Rat,NB_ECTS_SR FROM ESP_INSCRIPTION a WHERE (ID_ET =:ID_ET) and a.annee_deb=(select max(annee_deb) from societe)  ">
                                       <SelectParameters>
            <asp:SessionParameter Name="ID_ET" SessionField="ID_ET" Type="String" />
        </SelectParameters>
                                        </asp:SqlDataSource>
  ...
  <asp:Label ID="Label11" runat="server" Text='<%# Bind("NB_ECTS") %>'></asp:Label>
             ...
             <%--         <tr><td>       <asp:Label ID="Label17" runat="server" /></td></tr>--%>
                        ...
                        <asp:BoundField DataField="MOY_MODULE" HeaderText="MOYENNE MODULE PRINCIPALE"  
                         ...
                         <asp:BoundField DataField="MOY_MODULERATT" HeaderText="MOYENNE MODULE RATTRAPAGE"  
