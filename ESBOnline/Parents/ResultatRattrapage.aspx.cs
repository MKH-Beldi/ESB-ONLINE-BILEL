...
namespace ESPOnline.Parents
{
    public partial class ResultatRattrapage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CODE_CL = DAL.OrientationDAO.getlcodecl(ID_ET, "2017");
            TYPE_PV = DAL.OrientationDAO.getTypepv("2017", CODE_CL);
            LIB_DECISION_SESSION_RAT = DAL.OrientationDAO.getDecisionRat(ID_ET, "2017");
            CODE_DECISION_SESSION_RAT = DAL.OrientationDAO.getCodeDecisionRat(ID_ET, "2017");
            Moy_R = DAL.OrientationDAO.getMoyRat(ID_ET, "2017");



            //nb = DAL.OrientationDAO.getsumnbects(ID_ET, "2017");
            //ec = DAL.OrientationDAO.getsumnbects2(ID_ET, "2017");
            ...
            else if (TYPE_PV.ToString() == "E" && LIB_DECISION_SESSION_RAT != null && GridView2.Rows.Count != 0)
            {
                //Label18.Visible = false;
            ...
            else if (TYPE_PV.ToString() == "O" && LIB_DECISION_SESSION_RAT != null)
            {
                ...
                Response.Redirect("~/Parents/CharguiaRattrapage.aspx");
        ...
        protected void GridView1_test(object sender, GridViewRowEventArgs e)
        {
           ...
           // ec = DAL.OrientationDAO.getsumnbects2(ID_ET, "2017");
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                //    string t = Session["ID_ET"].ToString().Trim();
                //    string numc = Session["CIN_PASS"].ToString().Trim();
                //    OracleCommand cmd = new OracleCommand("SELECT MOY_GENERAL FROM ESP_INSCRIPTION where ANNEE_DEB=2017 and id_et='" + t + "'  ");
                ...
                //    string t = Session["ID_ET"].ToString().Trim();
                //    string numc = Session["CIN_PASS"].ToString().Trim();
                //    OracleCommand cmd = new OracleCommand("SELECT LIB_DECISION_SESSION_P FROM ESP_INSCRIPTION where ANNEE_DEB=2017 and id_et='" + t + "'  ");
