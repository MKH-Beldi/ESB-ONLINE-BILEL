<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NB_affec_spec.aspx.cs" Inherits="ESPOnline.Direction.NB_affec_spec"
...
<h3>Nb enseignants saisis et Nonn saisis par site, spécialité et classe</h3>
...
<asp:GridView runat="server" ID="Gridtoiec" AutoGenerateColumns="False" 
          ...
          <asp:BoundField DataField="Site" HeaderText="Site" ReadOnly="True" 
                SortExpression="Site" /> 
                  ...
                  <asp:BoundField DataField="Specialite" HeaderText="Specialite" ReadOnly="True" 
                SortExpression="Specialite" /> 
