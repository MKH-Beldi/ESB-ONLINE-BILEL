...
namespace ESPOnline.Direction
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = DAL.Admission.Instance.getnbparspe_niv("05", DropDownList1.SelectedItem.Value);
            ...
            DataTable dt1 = DAL.Admission.Instance.getnbparspe_niv("04", DropDownList1.SelectedItem.Value);
            ...
            for (int i = 0; i < dt1.Rows.Count; i++)
            {
                ...
                y[i] = Convert.ToInt32(dt1.Rows[i][3]);
            }
            LineChart1.Series.Add(new AjaxControlToolkit.LineChartSeries { Name = "EM", Data = y });
            DataTable dt2 = DAL.Admission.Instance.getnbparspe_niv("03", DropDownList1.SelectedItem.Value);
            ...
            for (int i = 0; i < dt2.Rows.Count; i++)
            {
                ...
                y[i] = Convert.ToInt32(dt2.Rows[i][3]);
            }
