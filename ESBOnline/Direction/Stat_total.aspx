<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Stat_total.aspx.cs" Inherits="ESPOnline.Direction.Stat_total"
...
<table>
<tr>
<td><asp:Label ID="lbl2" runat="server" BackColor="White" Font-Bold="True" 
        Font-Size="X-Large" ForeColor="#CC0000" ></asp:Label></td>
</tr>
<tr>
<td>

<h3>Répartition des étudiants par site,Classe,type d'inscription,Nouveau et redoublant</h3>
        ...
        <ItemTemplate>
         ...
         <FooterTemplate>
            <asp:Label ID="lblTotalUnitsInStockredoub" runat="server" />
                ...
                <%-- <asp:BoundField DataField="Pre_Inscrits" HeaderText="Pre_Inscrits" ReadOnly="True" 
                SortExpression="Pre_Inscrits" /> --%>
                 <asp:TemplateField HeaderText="Pre_Inscrits">
         <ItemTemplate>
            <asp:Label ID="lblUnitsInStockGCTprins" runat="server" Text='<%# Eval("Pre_Inscrits") %>' />
         </ItemTemplate>                   
         <FooterTemplate>
            <asp:Label ID="lblTotalUnitsInStockprins" runat="server" />
                ...
                <%--<asp:BoundField DataField="NB" HeaderText="NB" ReadOnly="True" 
                SortExpression="NB" /> --%>
                <asp:TemplateField HeaderText="NB">
         <ItemTemplate>
            <asp:Label ID="lblUnitsInStockNB" runat="server" Text='<%# Eval("NB") %>' />
         </ItemTemplate>                   
         <FooterTemplate>
