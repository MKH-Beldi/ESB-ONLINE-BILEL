<%@ Page Title="" Language="C#" MasterPageFile="~/Direction/Site2.Master" AutoEventWireup="true" CodeBehind="répartitiondescandidatsparscore.aspx.cs" Inherits="ESPOnline.Direction.répartitiondescandidatsparscore" %>
 <%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

<cc1:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"/>
    <center><asp:Label ID="Label1" runat="server" 
            Text="Répartition des candidats par score" 
            style="font-weight: 700; color: #CC0000; font-size: x-large"></asp:Label></center>
    <br />
