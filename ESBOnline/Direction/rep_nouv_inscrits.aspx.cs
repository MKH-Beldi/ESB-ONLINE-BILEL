...
{
    public partial class rep_nouv_inscrits : System.Web.UI.Page
    {
        ...
        protected void gridViewtoiec_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            Gridtoiec.DataBind();
            Gridtoiec.DataSource = service.Rep_nouv_inscrits();
            Gridtoiec.DataBind();
        }
        ...
        protected void BuTT2_Click(object sender, EventArgs e)
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=Rep_nouc_inscrits.xlsx");
