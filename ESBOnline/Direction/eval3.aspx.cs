...
{
    public partial class eval3 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label5.Text = nb3.ToString();
            DataView dv4 = (DataView)SqlDataSource3.Select(DataSourceSelectArguments.Empty);
            decimal nb4 = (decimal)dv4.Table.Rows[0][0];
            Label1.Text = nb4.ToString();
        }
        ...
        protected void BuTT2_Click(object sender, EventArgs e)
        {
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=evaluation_total.xlsx");
