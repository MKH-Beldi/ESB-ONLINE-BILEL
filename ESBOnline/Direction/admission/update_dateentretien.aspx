<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="update_dateentretien.aspx.cs" Inherits="ESPOnline.Direction.admission.update_dateentretien"
  ...
  <asp:Button  Text="Modifier specialité" ID="Button1" runat="server" onclick="btnmod_Click"/>--%>
    ...
    <center>
      ...
      <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>"
       ...
       <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT DISTINCT DATe_ent FROM ADMIS_ESB.date_ent e WHERE e.NOMBRE_CONDIDATS<e.NOMBR_MAX and substr(e.DATE_ENT,3,1)='-' and substr(DATE_ENT,8, 4)='2019'">
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>"
       ...
       <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
        ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
        SelectCommand="SELECT DISTINCT DATe_ent FROM SCO_ADMIS1415.date_ent e WHERE e.NOMBRE_CONDIDATS<e.NOMBR_MAX and substr(e.DATE_ENT,3,1)='-' and substr(DATE_ENT,8, 4)='2019'">
    </asp:SqlDataSource>
