<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfert_esb_1819.aspx.cs" 

Inherits="ESPOnline.Direction.admission.transfert_esb_1819" MasterPageFile="~/Direction/admission/ad.Master" %>
...
t1.SPECIALITE_ESP_ET='08' then 'Master en Management	Digital	et Systèmes d’Information'   when t1.SPECIALITE_ESP_ET='09' then 'Master en Marketing Digital' when t1.SPECIALITE_ESP_ET='10' then 'Master en Innovation	 Entrepreneuriat'   
end) SPECIALITE_ESP_ET ,T1.ID_ET,T1.dateentr,etab_origine, T1.TEL_ET,T1.NATIONALITE FROM   ESP_ETUDIANT t1  WHERE   id_et like '19%' and code_decision!='01' and envoi_mail!='O' order by specialite_esp_et desc ">
   ...
   <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ConnectionString5 %>" 
                        ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" 
                        SelectCommand="select count(*) from esp_etudiant where id_et LIKE '19%T%'"></asp:SqlDataSource>
   </center>
</asp:Content>