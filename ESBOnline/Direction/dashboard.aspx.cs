...
namespace ESPOnline.Direction
{
    public partial class dashboard : System.Web.UI.Page
    {
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            string connectionString = "User ID=admis_esb;Password=admis1718;Data Source=192.168.0.225:1521/bdesb10g";
            OracleConnection connection = new OracleConnection(@connectionString);
          
            OracleCommand cmd = new OracleCommand("select esp_etudiant.ID_ET from esp_etudiant where esp_etudiant.id_et like '22%' minus select esp_score_dossier.ID_ET from esp_score_dossier where score_dossier is not null and esp_score_dossier.id_et like '22%'",connection);
            connection.Open();
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            OracleCommand cmd = new OracleCommand("select esp_etudiant.ID_ET from esp_etudiant where esp_etudiant.id_et like '22%' minus select esp_etudiant.ID_ET from esp_etudiant  , score_final_2022 where score_final_2022.ID_ET = esp_etudiant.ID_ET and  esp_etudiant.id_et like '22%'", connection);
            connection.Open();
            OracleDataReader reader = cmd.ExecuteReader();
            dt = new DataTable();
            dt.Load(reader);
       ...
       // transfert scolarite
        ...
        public void mdp(object sender, EventArgs e)
        {
            ...
            string connectionString = "User ID=admis_esb;Password=admis1718;Data Source=192.168.0.225:1521/bdesb10g";
            OracleConnection connection = new OracleConnection(@connectionString);
            string query = "update scoesb03.esp_etudiant e  set e.pwd_et ='šŒ ÍÏÍÍ' where e.id_et like '22%' and e.pwd_et is null";
            OracleCommand command = new OracleCommand(query, connection);
            try
            {
                connection.Open();
        ...
        public void decision(object sender, EventArgs e)
        {
            ...
            string admis = "select e.ID_ET from ADMIS_ESB.esp_etudiant e, ADMIS_ESB.SCORE_FINAL_2022 f where e.id_et = f.id_et and e.id_et like'22%' and e.CODE_DECISION is null and f.sf2 >= 40";
            ...
            string refus = "select e.ID_ET from ADMIS_ESB.esp_etudiant e, ADMIS_ESB.SCORE_FINAL_2022 f where e.id_et = f.id_et and e.id_et like'22%' and e.CODE_DECISION is null and f.sf2 < 40";
