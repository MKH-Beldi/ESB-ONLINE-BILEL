...
{
    public partial class Chargeparenseignant : System.Web.UI.Page
    {
        string up;
        string nom;
        string z;
        ...
        {
            string id = RadComboBox2.SelectedValue.ToString();
            ...
            Repeater5.DataBind();
            Labelnomens.Text = "Enseignant : " + nom_ens;
            //Labelup.Text = up;
