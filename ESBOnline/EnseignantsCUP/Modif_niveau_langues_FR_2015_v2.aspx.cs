...
{
    public partial class Modif_niveau_langues_FR_2015_v2 : System.Web.UI.Page
    {
        ...
        protected void ddlannee_deb_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlannee_deb.SelectedValue != null)
            {
                ...
                ddclasse.DataSource = service.bind_classes_1516_cup(ddlannee_deb.SelectedValue);
        ...
        protected void OnRowDataBoundS(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (rblangue.SelectedValue == "FR")
                {
                    OracleCommand cmd = new OracleCommand("SELECT DISTINCT niveau_courant_fr FROM esp_etudiant");
                    ...
                    if (rblangue.SelectedValue == "AN")
                    {
                        OracleCommand cmd = new OracleCommand("SELECT DISTINCT niveau_courant_ang FROM esp_etudiant");
