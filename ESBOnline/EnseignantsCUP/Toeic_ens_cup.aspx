<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Toeic_ens_cup.aspx.cs" Inherits="ESPOnline.EnseignantsCUP.Toeic_ens_cup"
...
<asp:ListItem Value="2">Prep toeic</asp:ListItem>
  ...
  <br />
  <br />
  <%--<asp:DropDownList ID="ddlTOEIC" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
         >
  <asp:ListItem Value="">choisissez le test que vous voulez passer</asp:ListItem>
 ...
 <%-- <asp:DropDownList ID="ddlprepToeic" runat="server" AutoPostBack="true" AppendDataBoundItems="true"
         >
  <asp:ListItem Value="">choisissez le test que vous voulez passer</asp:ListItem>
