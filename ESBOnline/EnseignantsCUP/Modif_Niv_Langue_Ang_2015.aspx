<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modif_Niv_Langue_Ang_2015.aspx.cs" Inherits="ESPOnline.EnseignantsCUP.Modif_Niv_Langue_Ang_2015" 
...
<center>
<h3 class="style9"> Modification niveau de langues : Anglais</h3>
<br />
...
<%--<asp:ListItem Value="1">1er année</asp:ListItem>
<asp:ListItem Value="2">2eme année</asp:ListItem>
<asp:ListItem Value="3">3eme année</asp:ListItem>
<asp:ListItem Value="4">4eme année</asp:ListItem>
<asp:ListItem Value="5">5eme année</asp:ListItem>--%>
</asp:DropDownList>
</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td>
...
<asp:GridView runat="server" ID="Gridstudent" AutoGenerateColumns="False" AllowPaging="True" 
                                                         Style="border-bottom: white 2px ridge; border-left: white 2px ridge; background-color: white; 
                                                          width: 100%; border-top: white 2px ridge; border-right: white 2px ridge;"
                                                        ...
                                                        GridLines="None" EmptyDataRowStyle-CssClass="ItemStyle"  DataKeyNames="id_et" 
                                                       ...
                                                       >
                                                        ...
                                                        <%-- <RowStyle HorizontalAlign="center"></RowStyle>
                                                                    ...
                                                                    <HeaderStyle HorizontalAlign="Center" Height="20px" CssClass="HeaderStyle" />
                          ...
                          ID="BtnCancelUpdateCrewSalaryPayment" ImageAlign="Middle"  
...
<asp:TemplateField HeaderText="Nom et prenom de l'étudiant">
    ...
    <ItemTemplate>
        <asp:Label ID="lblPreNom" runat="server"
                Text='<%# Eval("NIV_ACQUIS_FRANCAIS")%>'></asp:Label>
    </ItemTemplate>
    <EditItemTemplate>
    ...
    <FooterTemplate>
        <asp:TextBox ID="txtSurnameNames" runat="server"></asp:TextBox>
            ...
            <asp:TemplateField HeaderText="Niveau acquis Anglais">
                <ItemTemplate>
                    <asp:Label ID="lablNature" runat="server" Text='<%# Eval("NIV_ACQUIS_ANGLAIS") %>'></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:DropDownList runat="server" ID="ddlniveau_etud" DataTextField="NIV_ACQUIS_ANGLAIS" DataValueField="NIV_ACQUIS_ANGLAIS">
                    </asp:DropDownList>
                </EditItemTemplate>
            </asp:TemplateField>
