<%@ Page Title="" Language="C#" MasterPageFile="~/EnseignantsCUP/Cup.Master" AutoEventWireup="true" CodeBehind="ExportToExcel2.aspx.cs" Inherits="ESPOnline.EnseignantsCUP.ExportToExcel2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
        ...
        <asp:Label ID="Label3" runat="server" 
            Text="Export affectation semestre 2 AU:2016/2016" Font-Size="X-Large" 
...
<EditColumn FilterControlAltText="Filter EditCommandColumn column"></EditColumn>
 ...
 AND ESP_MODULE_PANIER_CLASSE_SAISO.num_semestre=2  AND ESP_MODULE_PANIER_CLASSE_SAISO.annee_deb=2016 order by DESIGNATION
">  <SelectParameters>
