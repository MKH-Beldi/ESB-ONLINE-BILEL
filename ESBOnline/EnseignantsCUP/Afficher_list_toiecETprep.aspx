<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Afficher_list_toiecETprep.aspx.cs"
 Inherits="ESPOnline.EnseignantsCUP.Afficher_list_toiecETprep" MasterPageFile="~/EnseignantsCUP/cup.Master" EnableEventValidation = "false" %>
...
<tr>
<td valign="top" >
<h3>LISTE CANDIDATS POUR PASSER LE TEST TOIEC</h3>
...
<td valign="top" >
<h3>LISTE CANDIDATS POUR PASSER LE TEST PREPARATION TOIEC</h3>
...
<asp:HyperLink ID="HyperLink1" NavigateUrl="~/EnseignantsCUP/Afficher_list_commune.aspx" Text="Afficher la liste des candidats qui vont passer le test TOEIC et PREP TOEIC" runat="server" ForeColor="#0033CC" > </asp:HyperLink>
</center>
...
<tr><td><asp:Label ID="lblcountfr" runat="server" 
        Text="Le nombre des condidats qui vont passer la certification TOEIC (toeic)est:" 
...
<tr><td><asp:Label ID="lblcountang" runat="server" 
        Text="Le nombre des condidats qui vont preparer la certification TOEIC(prep toeic) est:" 
