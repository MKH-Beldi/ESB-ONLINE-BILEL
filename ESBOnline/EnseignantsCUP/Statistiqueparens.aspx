<%@ Page Title="" Language="C#" MasterPageFile="~/EnseignantsCUP/Cup.Master" AutoEventWireup="true" CodeBehind="Statistiqueparens.aspx.cs" Inherits="ESPOnline.EnseignantsCUP.Statistiqueparens" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center> <telerik:RadScriptManager ID="RadScriptManager1" runat="server">
...
<table style="height: 27px; width: 856px">
    ...
    <%--Etablir Par Défaut:--%>
            ...
            <tr>
                ...
                <td class="auto-style1"> 
            <asp:DropDownList ID="DDLAnnee" runat="server" CssClass="form-control" Height="36px" Width="350px"  OnSelectedIndexChanged="DDLAnnee_SelectedIndexChanged" AutoPostBack="True">
            ...
            <tr>
                ...
                <td class="auto-style1">
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" Height="36px" Width="350px" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged"   AutoPostBack="True">
