<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Afficher_List_ens_toeic_prep.aspx.cs" 
Inherits="ESPOnline.EnseignantsCUP.Afficher_List_ens_toeic_prep"  MasterPageFile="~/EnseignantsCUP/cup.Master" EnableEventValidation = "false" %>
...
<tr>
<td valign="top" >
<h3>LISTE ENSEIGNANTS POUR PASSER LE TOEIC</h3>
...
<td valign="top" >
<h3>LISTE ENSEIGNANTS POUR PASSER LA PREPARATION TOEIC</h3>
...
<asp:HyperLink ID="HyperLink1" NavigateUrl="~/EnseignantsCUP/Afficher_list_commun_ens.aspx" Text="Consulter la liste des enseignants qui von passer le toeic et la preparation toeic" runat="server" ForeColor="#0033CC" > </asp:HyperLink>
</center>
