<%@ Page Title="" Language="C#" MasterPageFile="~/EnseignantsCUP/Cup.Master" AutoEventWireup="true" CodeBehind="Affectation1415.aspx.cs" Inherits="ESPOnline.EnseignantsCUP.Affectation1415" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <asp:Button ID="Button2"
        runat="server" OnClick="ExportExcel" Text="ExportToExcel" /><br /><br />
            <center>
    
            <asp:GridView ID="gvClasses" runat="server" AutoGenerateColumns="false" CssClass="Grid"
            Width="99%" OnRowDataBound="OnRowDataBound" DataKeyNames="CODE_CL">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Visible="false"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="NB_HEURES" HeaderText="NB_HEURES" 
                SortExpression="NB_HEURES" />
            <asp:BoundField DataField="CHARGE_P1" HeaderText="CHARGE_P1" 
                SortExpression="CHARGE_P1" />
            <asp:BoundField DataField="CHARGE_P2" HeaderText="CHARGE_P2" 
                SortExpression="CHARGE_P2" />
            <asp:BoundField DataField="ENS1" HeaderText="ENS1" ReadOnly="True" 
                SortExpression="ENS1" />
            <asp:BoundField DataField="CHARGE_ENS1_P1" HeaderText="CHARGE_ENS1_P1" 
                SortExpression="CHARGE_ENS1_P1" />
            <asp:BoundField DataField="CHARGE_ENS1_P2" HeaderText="CHARGE_ENS1_P2" 
                SortExpression="CHARGE_ENS1_P2" />
            <asp:BoundField DataField="ENS2" HeaderText="ENS2" ReadOnly="True" 
                SortExpression="ENS2" />
            <asp:BoundField DataField="CHARGE_ENS2_P1" HeaderText="CHARGE_ENS2_P1" 
                SortExpression="CHARGE_ENS2_P1" />
            <asp:BoundField DataField="CHARGE_ENS2_P2" HeaderText="CHARGE_ENS2_P2" 
                SortExpression="CHARGE_ENS2_P2" />
            <asp:BoundField DataField="ENS3" HeaderText="ENS3" ReadOnly="True" 
                SortExpression="ENS3" />
            <asp:BoundField DataField="CHARGE_ENS3_P1" HeaderText="CHARGE_ENS3_P1" 
                SortExpression="CHARGE_ENS3_P1" />
            <asp:BoundField DataField="CHARGE_ENS3_P2" HeaderText="CHARGE_ENS3_P2" 
                SortExpression="CHARGE_ENS3_P2" />
            <asp:BoundField DataField="ENS4" HeaderText="ENS4" ReadOnly="True" 
                SortExpression="ENS4" />
            <asp:BoundField DataField="CHARGE_ENS4_P1" HeaderText="CHARGE_ENS4_P1" 
                SortExpression="CHARGE_ENS4_P1" />
            <asp:BoundField DataField="CHARGE_ENS4_P2" HeaderText="CHARGE_ENS4_P2" 
                SortExpression="CHARGE_ENS4_P2" />
            <asp:BoundField DataField="ENS5" HeaderText="ENS5" ReadOnly="True" 
                SortExpression="ENS5" />
            <asp:BoundField DataField="CHARGE_ENS5_P1" HeaderText="CHARGE_ENS5_P1" 
                SortExpression="CHARGE_ENS5_P1" />
            <asp:BoundField DataField="CHARGE_ENS5_P2" HeaderText="CHARGE_ENS5_P2" 
                SortExpression="CHARGE_ENS5_P2" />
            <asp:BoundField DataField="TYPE_EPREUVE" HeaderText="TYPE_EPREUVE" 
                ReadOnly="True" SortExpression="TYPE_EPREUVE" />
        </Columns>
    </asp:GridView>
 ...
 AND ESP_MODULE_PANIER_CLASSE_SAISO.num_semestre=1  AND ESP_MODULE_PANIER_CLASSE_SAISO.annee_deb=2014 order by DESIGNATION
">  <SelectParameters>
