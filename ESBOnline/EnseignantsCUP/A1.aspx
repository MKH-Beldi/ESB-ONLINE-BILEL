<%@ Page Title="" Language="C#" MasterPageFile="~/EnseignantsCUP/Cup.Master" AutoEventWireup="true" CodeBehind="A1.aspx.cs" Inherits="ESPOnline.EnseignantsCUP.A1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadFormDecorator ID="QsfFromDecorator" runat="server" DecoratedControls="All" EnableRoundedCorners="false" />--%>
        ...
        <br />
        <asp:Label ID="Label4" runat="server" Text="Seances d'Encadrements:"></asp:Label>
        <br />
