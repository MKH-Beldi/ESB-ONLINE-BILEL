<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Liste_Formation_langue_Commun.aspx.cs" 
Inherits="ESPOnline.EnseignantsCUP.Liste_Formation_langue_Commun" 
...
<br />
<br />
<center><h1 class="style3">Liste des etudiants inscrits au formation français et 
    anglais <asp:Label ID="lblanneedeb" runat="server" CssClass="style7" Visible="false"></asp:Label>/<asp:Label 
            ID="lblanneefin" runat="server" CssClass="style7" Visible="false"></asp:Label></h1>
        </center>
...
<tr>
<td valign="top" >
<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Liste des etudiants inscrits au formation français et anglais</h3>
...
Height="50px" ForeColor="Black" BackColor="#CCCCCC" onclick="Btntoiec_Click" CssClass="text-info" />
 ...
 <br />
 <center>
<h3 class="style2">Cliquez sur le bouton bour afficher le nombre des condidats qui vont passer le test TOEIC ET PREPTOEIC</h3>
...
<center>
<table>
<tr><td>Liste des etudiants inscrits au formation français et anglais: </td><td>
        <asp:Label  ID="lblnbtoiec"  

            runat="server" CssClass="style1" BackColor="#66FFCC" Height="50px" 
...
<asp:HyperLink ID="HyperLink1" NavigateUrl="~/EnseignantsCUP/List_Formation_langues.aspx" Text="Retour à la première page" runat="server" ForeColor="#0033CC" > </asp:HyperLink>
</center>
