<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modif_niv_lgrfr_ang_2015_v2.aspx.cs" 
Inherits="ESPOnline.Enseignants.Modif_niv_lgrfr_ang_2015" 
...
<asp:TemplateField HeaderText="Nom et prenom de l'étudiant">
        ...
        <asp:TemplateField HeaderText="Niveau Français">
               ...
               <asp:DropDownList ID="ddlCountries" runat="server" Visible = "false" OnSelectedIndexChanged="ddlDropDownList122_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true">
               </asp:DropDownList>
            </ItemTemplate>
            </asp:TemplateField>
             ...
             <ItemTemplate>
                ...
                <asp:DropDownList ID="ddlCountries2" runat="server" Visible = "false" OnSelectedIndexChanged="ddlDropDownList122_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true">
                </asp:DropDownList>
            </ItemTemplate>
                <%--<ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Niveau Français">
                ...
                <EditItemTemplate>
                    <asp:DropDownList runat="server" ID="ddlniveau_fr" DataTextField="niveau_courant_fr" DataValueField="niveau_courant_fr"
                     OnSelectedIndexChanged="ddlDropDownList_SelectedIndexChanged" AutoPostBack="true" AppendDataBoundItems="true">
                    </asp:DropDownList>
                </EditItemTemplate>
            </asp:TemplateField>
             <asp:TemplateField HeaderText="Niveau Anglais">
...
<%--<asp:TemplateField   HeaderText = "Niveau Anglais">
    <ItemTemplate>
        <asp:Label ID="lblPreNom" runat="server"
                Text='<%# Eval("niveau_courant_ang")%>'></asp:Label>
    </ItemTemplate>
    <EditItemTemplate>
