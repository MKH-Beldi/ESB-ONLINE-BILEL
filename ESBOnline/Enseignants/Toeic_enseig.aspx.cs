...
{
    public partial class Toeic_enseig : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                ...
                else
                {
                    if (nbtoiec < 299 || nbprep < 299)
                    {
                        if (nbtoiec < 299)
                        {
                            Response.Redirect("~/Enseignants/Inscrit_TOEICens.aspx");
                        ...
                        if (nbprep < 299)
                        {
                            Response.Redirect("~/Enseignants/Inscrit_TOEIC_PREPens.aspx");
