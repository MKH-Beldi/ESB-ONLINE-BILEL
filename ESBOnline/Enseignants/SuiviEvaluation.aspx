<%@ Page Title="" Language="C#" MasterPageFile="~/Enseignants/Ens.Master" AutoEventWireup="true"
    CodeBehind="SuiviEvaluation.aspx.cs" Inherits="ESPOnline.Enseignants.SuivieEvaluation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel2" runat="server">
        <h3 class="text-center text-info">
            <strong>Suivi des evaluations des enseignements par les etudiants</strong></h3>
    </asp:Panel>
    <div class="row">
        <div class="col-xs-3">
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="form-inline">
                                <div class="form-group">
                                    <br />
                                    <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource3" Width="881px"
                                        Palette="SemiTransparent" Height="402px">
                                        <Series>
...
(SELECT COUNT(*) FROM esp_module_panier_classe_saiso WHERE annee_deb='2013' AND code_cl = esp_evaluation.code_cl) c_nb_module FROM esp_evaluation WHERE annee_deb='2013' and code_cl &lt;&gt; '4TELB2' GROUP BY code_cl) order by Taux DESC)">
    ...
    CurrentSortDirection="DESC"  AllowSorting="true"
                                ...
                                <ItemTemplate>
                                   ...
                                   <span class="style1"><strong><span class="style2">Nombre Total des evaluations</span>:</strong></span><asp:FormView ID="formview3" runat="server" DataSourceID="SqlDataSource7">
                                    <ItemTemplate>
