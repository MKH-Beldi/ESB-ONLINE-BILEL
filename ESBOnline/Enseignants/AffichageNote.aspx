<%@ Page Title="" Language="C#" MasterPageFile="~/Enseignants/Ens.Master" AutoEventWireup="true" CodeBehind="AffichageNote.aspx.cs" Inherits="ESPOnline.Enseignants.AffichageNote" %>
     ...
     <table class="style1">
       ...
       <asp:DropDownList  ID="DropDownList1" runat="server"  AutoPostBack="True"  
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" 
            SelectMethod="GetListNotes" TypeName=" ESPOnline.Enseignants.Classenote">
            <SelectParameters>
      ...
      <td><strong><span class="alert-dismissable">Module:</span></strong>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
            SelectMethod="GetListNotes" TypeName="ESPOnline.Enseignants.modulnote" 
