<%@ Page Title="" Language="C#" MasterPageFile="~/Enseignants/Ens.Master" AutoEventWireup="true" CodeBehind="Statistiques.aspx.cs" Inherits="ESPOnline.Enseignants.Statistiques" %>
...
<table style="height: 27px; width: 856px">
    ...
    <%--Etablir Par Défaut:--%>
            ...
            <tr>
                ...
                <td class="auto-style1"> 
            <asp:DropDownList ID="DDLAnnee" runat="server" CssClass="form-control" Height="36px" Width="215px" OnSelectedIndexChanged="DDLAnnee_SelectedIndexChanged" AutoPostBack="True">
           <asp:ListItem Selected="True" Text="CHOISIR ANNEE" Value="">
                                                </asp:ListItem>
            ...
            <tr>
                ...
                <td class="auto-style1">
            <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" Height="36px" Width="215px" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="True">
     <asp:ListItem Selected="True" Text="CHOISIR CLASSE" Value="">
                                                </asp:ListItem>
    </asp:DropDownList> 
            ...
            <tr>
                ...
                <td class="auto-style1">
            <asp:DropDownList ID="DropDownList2" runat="server" CssClass="form-control" Height="36px" Width="215px" OnSelectedIndexChanged="DropDownList3_SelectedIndexChanged" AutoPostBack="True">
    </asp:DropDownList> 
