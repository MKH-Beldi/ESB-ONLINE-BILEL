<%@ Page Title="" Language="C#" MasterPageFile="~/Enseignants/Ens.Master" AutoEventWireup="true" CodeBehind="SuiviGroupe.aspx.cs" Inherits="ESPOnline.Enseignants.SuiviGroupe" %>
...
<asp:ObjectDataSource ID="ObjectDataSource2" runat="server" 
        SelectMethod="GetProjByGROUPEProjet" 
        TypeName="ESPSuiviEncadrement.ESP_ENCADREMENT_GP">
        <SelectParameters>
            <asp:SessionParameter Name="id_proj" SessionField="ID_PROJET" Type="String" />
           <asp:SessionParameter Name="ID_GROUPE_PROJET" SessionField="ID_GROUPE_PROJET" Type="String" />
    ...
    <div class ="container">
        ...
        <table class="table">
            <tr>
                <td class="style1" rowspan="2">
                    <h4><asp:Label ID="Label1" CssClass="text-success pull-left" runat="server" Text="Encadrement Par Groupe"></asp:Label></h4>
                </td>
                ...
                <td class="style2">
                    <asp:Label ID="Label3" runat="server" CssClass="text-info pull-left" 
                        Text=" Nom Groupe : "></asp:Label>
                </td>
                <td class="style1">
                    <asp:Label ID="Label4" runat="server" CssClass="text-danger pull-right" 
                        Text=""></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td class="style1">
                    <asp:Label ID="Label6" runat="server" CssClass="text-danger pull-right" 
                        Text=""></asp:Label>
                </td>
        ...
        <HeaderTemplate >
            <tr class="alert-danger">
                ...
                <td rowspan="2">
                    <span>
                    <asp:Label ID="Label22" runat="server" CssClass="text-center text-muted" 
                        Text="Note De groupe"></asp:Label>
                    </span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <td>
                    <%# DataBinder.Eval(Container.DataItem, "NOTE_GROUPE")%></td>
            </tr>
            </tr>
            </ItemTemplate>
            <FooterTemplate>
...
<%--<div class="navbar-brand btn-group pull-right"><asp:Button ID="Button1" runat="server" CssClass="btn btn-danger" Text="Retour" 
