...
CodeBehind="Entretiensession2.aspx.cs" Inherits="ESPOnline.Enseignants.Entretiensession2" MasterPageFile="~/Enseignants/Ens.Master" %>
                                    ...
                                    <td colspan="13">
                                        <table class="style1" border="5" frame="border">
                                            <tr>
                                                ...
                                                <td>
                                                   langue et<br /> communication française
                                                </td>
                                                <td>
                                            ...
                                            <tr><td class="style4">Observation</td><td colspan="6"  dir="ltr" class="style4">
                                                <asp:TextBox ID="TextBox2" runat="server" Height="52px" Width="693px" 
